...
namespace TranSmart.Static
{
    public class PdfMan
    {
        ...
        private RadFixedDocument CreateDocument()
        {
            ...
            using (FileStream fs = new FileStream(HttpContext.Current.Server.MapPath("~/PdfProcessing/SampleData/pdfProcessingAjax.png"), FileMode.Open, FileAccess.Read))
            {
                editor.DrawImage(fs);
            }
            ...
            using (FileStream fs = new FileStream(HttpContext.Current.Server.MapPath("~/PdfProcessing/SampleData/telerik.png"), FileMode.Open, FileAccess.Read))
            {
                editor.DrawImage(fs);
            }
