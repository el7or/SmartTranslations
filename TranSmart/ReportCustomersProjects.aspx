<%@ Page Title="Customer Projects Report" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportCustomersProjects.aspx.cs" Inherits="TranSmart.ReportCustomersProjects" %>
            ...
            <fieldset class="fsRow" style="width: 100% !important; background-image: linear-gradient(#ebebeb,#fff);">
                <legend class="rdfLegend rfdRoundedCorners ">
                    <fieldset style="padding: 8px; font-size: 16px; font-weight: 500;">
                        <asp:Label ID="lblHeader" runat="server" Text="Number Projects of Clients"></asp:Label>
                    </fieldset>
                </legend>
                <div class="demo-container no-bg outerMultiPage">
                    ...
                    <div class="ingredients qsf-ib">
                        <telerik:RadGrid ID="grdClientList" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                            CommandItemStyle-HorizontalAlign="Center" OnItemCreated="grdClientList_ItemCreated"
                            ...
                            <MasterTableView DataKeyNames="CustomerID" TableLayout="Auto">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="ProjectsCount" FilterControlAltText="Filter ProjectsCount column"
                                        HeaderText="Number of Projects" UniqueName="ProjectsCount">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
