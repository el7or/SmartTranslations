<%@ Page Title="Translator Invoices Report" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportTranslatorInvoices.aspx.cs" Inherits="TranSmart.ReportTranslatorInvoices" %>
            ...
            <fieldset class="fsRow" style="width: 100% !important; background-image: linear-gradient(#ebebeb,#fff);">
                <legend class="rdfLegend rfdRoundedCorners ">
                    <fieldset style="padding: 8px; font-size: 16px; font-weight: 500;">
                        <asp:Label ID="lblHeader" runat="server" Text="Staff invoices"></asp:Label>
                    </fieldset>
                </legend>
                <div class="demo-container no-bg outerMultiPage">
                        <h3><asp:Label ID="lblPickMonth" runat="server" Text="Pick a month:  "></asp:Label></h3>                        
                        <telerik:RadMonthYearPicker ID="RadDatePicker2" runat="server" AutoPostBack="true" OnSelectedDateChanged="RadDatePicker2_SelectedDateChanged" >
                    ...
                    <div class="ingredients qsf-ib">
                        <telerik:RadGrid ID="grdTransList" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                            CommandItemStyle-HorizontalAlign="Center" OnItemCreated="grdTransList_ItemCreated"
                            ...
                            <MasterTableView DataKeyNames="EmployeeID" TableLayout="Auto">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="TasksCount" FilterControlAltText="Filter TasksCount column"
                                        HeaderText="Tasks Count" UniqueName="TasksCount">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="TotalWordCount" FilterControlAltText="Filter TotalWordCount column"
                                        HeaderText="Total Words Count" UniqueName="TotalWordCount">
                                    </telerik:GridBoundColumn>                                    
                                    <telerik:GridBoundColumn DataField="WordPrice" FilterControlAltText="Filter WordPrice column"
                                        HeaderText="Word Price" UniqueName="WordPrice">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="TotalTasksCost" FilterControlAltText="Filter TotalTasksCost column"
                                        HeaderText="Total Tasks Cost" UniqueName="TotalTasksCost">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="BasicSalary" FilterControlAltText="Filter BasicSalary column"
                                        HeaderText="Current Salary" UniqueName="BasicSalary">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
